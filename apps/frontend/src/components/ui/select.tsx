...
// =============================================================================
// O QUE FAZ:
//   Componente Select (dropdown de seleção) acessível usando @radix-ui/react-select.
//   Substitui o <select> nativo com visual customizado mantendo acessibilidade.
//
// COMO USAR:
...
// Seta para cima no topo do scroll
...
// Seta para baixo no fundo do scroll
...
// Conteúdo do dropdown (a lista de opções)
